...
public class AddressAPITest extends BaseTest {
    ...
    private static final String DEFAULT_LOCATION = "Madhapur"; // Can be changed to any location
    ...
    // -------------------------------
    private Map<String, Object> buildAddressPayload(String userId, String firstName, String lastName, String mobile, String locationName) {
        ...
        if (latitude == null) latitude = "17.432464";
        if (longitude == null) longitude = "78.4071173";
    ...
    private Response callAddAddressAPI(String token, Map<String, Object> payload) {
        ...
        if (statusCode == 201) {
            ...
            return response; // Return early, skip validation for duplicates
        } else {
    ...
    private void validateAddressResponse(Response response, Map<String, Object> sentPayload) {
        ...
        AssertionUtil.verifyEquals(receiverName, sentPayload.get("receiver_name"), "Receiver name should match sent payload");
        ...
        AssertionUtil.verifyEquals(recipientMobile, sentPayload.get("recipient_mobile_number"), "Mobile number should match sent payload");
    ...
    // ---------------------------------------------------------
    @Test(priority = 11, dependsOnMethods = "com.mryoda.diagnostics.api.tests.GetCartByIdAPITest.testGetCartById_ForNonMember")
    ...
    // ---------------------------------------------------------
    @Test(priority = 11, dependsOnMethods = "com.mryoda.diagnostics.api.tests.GetCartByIdAPITest.testGetCartById_ForMember")
    ...
    // ---------------------------------------------------------
    @Test(priority = 12, dependsOnMethods = "com.mryoda.diagnostics.api.tests.GetCartByIdAPITest.testGetCartById_ForNewUser")
    ...
    // ---------------------------------------------------------
    // 4️⃣ EXISTING MEMBER → Add Another Address (Different Location - Guntur)
    // ---------------------------------------------------------
    @Test(priority = 13, dependsOnMethods = "testAddAddress_ForNonMember")
    public void testAddAddress_ForNonMember_DifferentLocation() {

        System.out.println("\n╔══════════════════════════════════════════════════════════╗");
        System.out.println("║     ADD ANOTHER ADDRESS — EXISTING MEMBER (Guntur)       ║");
        System.out.println("╚══════════════════════════════════════════════════════════╝\n");
        ...
        String firstName = RequestContext.getNonMemberFirstName();
        String lastName = RequestContext.getNonMemberLastName();
        String mobile = "8220220227";
        
        String newLocation = "Guntur"; // Different location
        System.out.println("🔹 Using Location: " + newLocation);
        System.out.println("🔹 User: " + firstName + " " + lastName);
        System.out.println("🔹 Mobile: " + mobile);
        
        Map<String, Object> payload = buildAddressPayload(userId, firstName, lastName, mobile, newLocation);
        payload.put("name", "Office"); // Different address type
        payload.put("type", "office");
    ...
    // ---------------------------------------------------------
    // 5️⃣ MEMBER → Add Another Address (Different Location - Tirupati)
    // ---------------------------------------------------------
    @Test(priority = 13, dependsOnMethods = "testAddAddress_ForMember")
    public void testAddAddress_ForMember_DifferentLocation() {

        System.out.println("\n╔══════════════════════════════════════════════════════════╗");
        System.out.println("║     ADD ANOTHER ADDRESS — MEMBER (Tirupati)              ║");
        System.out.println("╚══════════════════════════════════════════════════════════╝\n");
        ...
        String newLocation = "Tirupati"; // Different location
        System.out.println("🔹 Using Location: " + newLocation);
        System.out.println("🔹 User: " + firstName + " " + lastName);
        System.out.println("🔹 Mobile: " + mobile);
        
        Map<String, Object> payload = buildAddressPayload(userId, firstName, lastName, mobile, newLocation);
        payload.put("name", "Work"); // Different address type
